    ...
    <form class="col s12" action="Register" method="post" onsubmit="return formValidate()">
      <div class="row">
        <div class="input-field col s12">
          ...
          <label for="first_name" style="color:white">Name</label>
          <span>
      ...
      <div class="row">
        <div class="input-field col s12">
          <input placeholder="YYYY-MM-DD" name="dob" type="text" class="validate" style="color:white">
          <label for="password">DOB</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
          <input placeholder="Enter Basic Salary" name="basicSal" type="number" class="validate" style="color:white">
